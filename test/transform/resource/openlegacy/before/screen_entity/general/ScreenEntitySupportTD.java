...
@org.openlegacy.core.annotations.screen.ScreenEntity(supportTerminalData=true) public class ScreenEntitySupportTD {
	
	@org.openlegacy.core.annotations.screen.ScreenField(row = 6, column = 33, endColumn = 52, labelColumn = 2, displayName = "Item Name", sampleValue = "A") private String itemName;
