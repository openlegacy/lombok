...
//  also you need to attach org.openlegacy-openlegacy-api.jar to the test launch to get use of openlegacy annotaions
...
public class OLTestRpcEntity extends DirectoryRunner.TestParams {

    public static final String OL_BEFORE_DIRECTORY = "test/transform/resource/openlegacy/before/rpc_entity/general";
    public static final String OL_AFTER_DIRECTORY = "test/transform/resource/openlegacy/after-ecj/rpc_entity/general";
