...
// You need to add the following vm-parameters to run the test:
...
public class OLTestDbEntityOverrides extends DirectoryRunner.TestParams {

    public static final String OL_BEFORE_DIRECTORY = "test/transform/resource/openlegacy/before/db_entity/overrides";
    public static final String OL_AFTER_DIRECTORY = "test/transform/resource/openlegacy/after-delombok/db_entity/overrides";
