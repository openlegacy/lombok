...
public class OLTestRpcEntityOverrides extends DirectoryRunner.TestParams {
    ...
    public static final String OL_BEFORE_DIRECTORY = "test/transform/resource/openlegacy/before/rpc_entity/overrides_delombok";
    public static final String OL_AFTER_DIRECTORY = "test/transform/resource/openlegacy/after-delombok/rpc_entity/overrides";
