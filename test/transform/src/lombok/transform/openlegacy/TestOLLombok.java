...
//  also you need to attach openlegacy-core.jar to the test launch to get use of openlegacy annotaions
// add javax.persistence.jar, jackson-annotations.jar and persistance-api.jar to compile appropriate annotations; 
